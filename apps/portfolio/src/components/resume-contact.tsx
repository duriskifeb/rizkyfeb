...
export const ResumeContact = () => {
  ...
  return (
    <section
      ref={containerRef}
      id='contact'
      className='relative flex min-h-[80vh] w-full items-center justify-center overflow-hidden bg-[#0b0b0d] px-6 py-24 md:px-12'
    >
      ...
      <div className='pointer-events-none absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 opacity-30'>
        <div className='absolute inset-0 animate-pulse rounded-full bg-blue-500/20 blur-[120px]' />
        <div className='absolute left-10 top-10 h-full w-full animate-pulse rounded-full bg-purple-500/20 blur-[120px] delay-1000' />
      </div>
      ...
      <div className='relative z-10 mx-auto w-full max-w-4xl'>
        ...
        <motion.div
          ...
          className='overflow-hidden rounded-3xl border border-white/10 bg-[#121212]/50 backdrop-blur-xl'
        >
