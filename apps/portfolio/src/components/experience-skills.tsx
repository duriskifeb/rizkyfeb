  ...
  return (
    ...
    >
      ...
      <div className='absolute bottom-0 left-0 top-0 flex w-8 flex-col items-center'>
        ...
        <div className='relative z-10 mt-6 h-3 w-3 rounded-full border-2 border-blue-500 bg-[#0b0b0d] shadow-[0_0_10px_rgba(59,130,246,0.6)]'>
          <div className='absolute inset-0 animate-ping rounded-full bg-blue-500/20 opacity-75' />
        </div>
      </div>
      ...
      <div className='group relative rounded-2xl border border-white/10 bg-white/[0.02] p-6 transition-all duration-300 hover:border-white/20 hover:bg-white/[0.04]'>
        <div className='mb-4 flex flex-col justify-between gap-3 sm:flex-row sm:items-start'>
          <div>
            <h3 className='font-elgocAlt text-xl font-bold text-white transition-colors group-hover:text-blue-400'>
              {exp.role}
            </h3>
          ...
          <div className='shrink-0 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 font-mono text-xs text-blue-300'>
            {exp.period}
          </div>
        </div>
...
export const ExperienceSkills = () => {
  ...
  return (
    <section
      ...
      className='relative w-full bg-[#0b0b0d] px-6 py-24 md:px-12'
    >
      {/* Decor */}
      <div className='pointer-events-none absolute right-[-5%] top-[20%] h-[400px] w-[400px] rounded-full bg-blue-900/10 blur-[100px]' />
        ...
        <div className='relative z-20 flex h-full flex-col lg:sticky lg:top-24 lg:self-start'>
          ...
          <div className='group relative flex min-h-[450px] flex-1 flex-col items-center justify-center overflow-hidden rounded-3xl border border-white/10 bg-white/[0.02] p-10 text-center transition-all duration-500 hover:bg-white/[0.04]'>
            ...
            <div className='relative z-10 mb-8'>
              <div className='mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 text-white shadow-[0_0_30px_rgba(59,130,246,0.15)] transition-transform duration-500 group-hover:scale-110'>
      ...
      <AnimatePresence>
        {showRequestModal && (
          <>
            ...
            />
            <motion.div
              className='fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-white/10 bg-[#121212] p-8 shadow-2xl'
            ...
            >
              ...
              <div className='mb-8 rounded-xl border border-white/10 bg-white/[0.03] p-5'>
                ...
                <div className='flex items-center gap-3'>
                  <code className='flex-1 truncate rounded bg-blue-400/10 px-3 py-1.5 font-mono text-base text-blue-400'>
                    {data.resume.email}
                  </code>
                  <button
