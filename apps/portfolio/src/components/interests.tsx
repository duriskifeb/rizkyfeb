  ...
  const bubbleConfigs = [
    {
      ...
      transform: {
        x: { direction: 'left' as const, step: 200 },
        y: { direction: 'top' as const, step: 100 },
      },
    },
    {
    ...
    },
    {
      ...
      transform: {
        x: { direction: 'left' as const, step: 50 },
        y: { direction: 'top' as const, step: 200 },
      },
    },
    {
      ...
      transform: {
        x: { direction: 'right' as const, step: 400 },
        y: { direction: 'top' as const, step: 0 },
      },
    },
    {
      ...
      transform: {
        x: { direction: 'right' as const, step: 200 },
        y: { direction: 'top' as const, step: 400 },
      },
    },
    {
      className: 'absolute -bottom-16 -left-96 z-[4] sm:-left-[28rem]',
      rotation: { initial: 10, final: -30 },
      transform: {
        x: { direction: 'right' as const, step: 150 },
        y: { direction: 'bottom' as const, step: 100 },
      },
    },
    {
      className: 'absolute top-[55%] -right-20 z-[4]',
      rotation: { initial: -10, final: 25 },
      transform: {
        x: { direction: 'right' as const, step: 300 },
        y: { direction: 'top' as const, step: 150 },
      },
    },
    {
      className: 'absolute bottom-[15%] -left-20 z-[4]',
      rotation: { initial: 20, final: -15 },
      transform: {
        x: { direction: 'left' as const, step: 250 },
        y: { direction: 'bottom' as const, step: 200 },
      },
    },
    {
      className: 'absolute top-[10%] -right-32 z-[4]',
      rotation: { initial: -5, final: 35 },
      transform: {
        x: { direction: 'right' as const, step: 180 },
        y: { direction: 'bottom' as const, step: 120 },
      },
    },
    {
      className: 'absolute bottom-[25%] right-[8%] z-[4]',
      rotation: { initial: -20, final: 20 },
      transform: {
        x: { direction: 'right' as const, step: 280 },
        y: { direction: 'bottom' as const, step: 160 },
      },
    },
  ];
      ...
      <div className='relative'>
        ...
        {interests.map((interest, index) => {
          const config = bubbleConfigs[index] ?? {
            ...
            transform: {
              x: { direction: 'left' as const, step: 0 },
              y: { direction: 'top' as const, step: 0 },
            },
          };
