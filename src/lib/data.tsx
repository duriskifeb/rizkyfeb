...
export const data: Data = {
  ...
  resume: {
    description: ``,
    website: 'https://rizkyfeb.vercel.app',
    name: 'M Rizky Febriyanto',
    position: 'Software Engineer',
    email: 'rizkyfeb@gmail.com',
  ...
  contact: {
    links: [
      {
        title: 'Email',
        link: 'mailto:rizkyfeb@gmail.com',
      },
      {
        title: 'Twitter / X',
        link: 'https://x.com/rizkyfeb',
      },
      {
        title: 'LinkedIn',
        link: 'https://www.linkedin.com/in/rizkyfeb',
      },
      {
        title: 'GitHub',
        link: 'https://github.com/rizkyfeb',
      },
    ],
  },
};
